        ...
        <ul className="flex justify-evenly items-center my-5 md:my-0 md:space-x-5 md:mr-5">
          <li>
            <a href={instagram} target="_blank" rel="noreferrer noopener">
              ...
              >
                <path
                    d="M21 0H11C4.935 0 0 4.935 0 11v10c0 6.065 4.935 11 11 11h10c6.065 0 11-4.935 11-11V11c0-6.065-4.935-11-11-11zm8 21c0 4.418-3.582 8-8 8H11c-4.418 0-8-3.582-8-8V11c0-4.418 3.582-8 8-8h10c4.418 0 8 3.582 8 8v10z"
                  />
                  <path
                    d="M16 7.333a8.667 8.667 0 100 17.334 8.667 8.667 0 000-17.334zm0 14a5.333 5.333 0 110-10.667 5.333 5.333 0 010 10.667z"
                  />
                  <path
                    d="M23.25 9.75a.75.75 0 100 1.5.75.75 0 000-1.5z"
                  />
              </svg>
            </a>
          </li>
